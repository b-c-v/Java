...
class XOGameFrame extends JFrame {
    ...
    public boolean isWon(char token) {
        ...
        return (cells[0][3].getToken() == token)
    ...
    public class Cell extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            if (token == 'X') {
                ...
                Image aXImage = new ImageIcon("src\\com\\bcv\\homeWorkLemon\\Lection9\\x.gif").getImage();
                g.drawImage(aXImage, 0, 0, getHeight(), getHeight(), null);

            } else if (token == 'O') {
                // g.drawOval(10, 10, getWidth() - 20, getHeight() - 20);
                Image aOImage = new ImageIcon("src\\com\\bcv\\homeWorkLemon\\Lection9\\o.gif").getImage();
